...
public class ElementUtil {
	...
	public ElementUtil(WebDriver idriver) {
		this.idriver = idriver;
		jsUtil = new JavaScriptUtil(idriver);
	}

	public WebElement getElement(By locator) {
		WebElement element = idriver.findElement(locator);
	...
	public List<WebElement> getElements(By locator) {
		return idriver.findElements(locator);
	}
	...
	public WebElement waitForElementPresence(By locator, int timeOut) {
		WebDriverWait wait = new WebDriverWait(idriver, Duration.ofSeconds(timeOut));
	...
	public WebElement waitForElementPresenceWithFluentWait(int timeOut, int pollingTime, By locator) {
		Wait<WebDriver> wait = new FluentWait<WebDriver>(idriver).withTimeout(Duration.ofSeconds(timeOut))
